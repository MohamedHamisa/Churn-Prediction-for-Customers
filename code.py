...
import pandas_profiling  #get summery of data like missing and unique values
import plotly.offline as po #generate graphs offline 
import plotly.graph_objs as go  #object scatter
...
churn_dataset = pd.get_dummies(churn_dataset, columns = ['Contract','Dependents','DeviceProtection','gender',
                              ...
                              drop_first=True)  #it reduces the correlation between dummies and reduce the extra data
...
Model_Comparison_df.reset_index()  #to bring every column at the same level
